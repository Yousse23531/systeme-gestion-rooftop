...
export interface Achat {
  ...
  expiree?: boolean; // For items that have been expired
  expireeQuantite?: number; // Quantity that has been expired
  expireeDate?: string; // Date when item was expired
  expireeMotif?: string; // Reason for expiration
  supprime?: boolean; // For items that have been deleted
  supprimeDate?: string; // Date when item was deleted
  supprimeMotif?: string; // Reason for deletion
}
